        ...
        userRepository.getUsers(new BookRepository.ApiCallback<List<User>>() {
            ...
            public void onSuccess(List<User> users) {
                ...
                if (loginSuccessful) {
                    ...
                    Toast.makeText(Login_activity.this, "Login correcto", Toast.LENGTH_SHORT).show();
                    // Aquí se hace la transición solo si el login es exitoso
                    Intent intent = new Intent(Login_activity.this, Libreria.class);
                    startActivity(intent);
                } else {
                    System.out.println("Login incorrecto");
                    Toast.makeText(Login_activity.this, "Login incorrecto", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Throwable t) {
                ...
                Toast.makeText(Login_activity.this, "Error fetching users", Toast.LENGTH_SHORT).show();
            }
        });
    }
}